...
static struct {
    ...
    run_fn *fn;
        ...
        [dumb_fn_loop_1000_2api] = {.str_id = "dumb_fn_loop_1000_2api", .id = dumb_fn_loop_1000_2api, .fn = loop_1000_2api},
        [dumb_fn_loop_1000_3api] = {.str_id = "dumb_fn_loop_1000_3api", .id = dumb_fn_loop_1000_3api, .fn = loop_1000_3api},
        [dumb_fn_loop_1000_getset] = {.str_id = "dumb_fn_loop_1000_getset", .id = dumb_fn_loop_1000_getset, .fn = loop_1000_getset},
};
